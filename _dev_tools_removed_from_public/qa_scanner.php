...
$lint = shell_exec('php -l "D:\\blueboxx\\blueboxx web\\backend\\app\\Http\\Controllers\\Api\\Admin\\AdminCertificateController.php" 2>&1');
echo json_encode(['lint_result' => $lint]);
exit;
