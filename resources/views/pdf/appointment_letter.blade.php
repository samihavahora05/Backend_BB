...
<style>
  ...
  * {
  ...
  /* Fallback header/footer if background image is missing */
  .fallback-header {
    margin-bottom: 12px;
  }
  .fallback-logo-title {
...
<div class="page-container">
  @if(!empty($letterhead_bg_base64))
    <!-- Full-bleed Official BlueBoxx DA Letterhead Background -->
    <img src="{{ $letterhead_bg_base64 }}" class="letterhead-bg" alt="Letterhead Background" />
  @else
    <!-- Vector Fallback Accents -->
    ...
    <div class="fallback-footer">
      <div style="font-size: 9px; font-weight: bold; color: #0d1635;">Ph: +91-7798575777 | Email: info.blueboxx@gmail.com | Web: www.blueboxx.in</div>
      <div style="font-size: 8px; color: #1a202c;">SF-02, Indiabulls, Mega Mall Nr. Jetalpur, Bridge, Akota Road, Akota, Vadodara</div>
    </div>
  @endif
  ...
  <div class="content-wrapper">
    ...
    <div class="signature-container">
      ...
      <table cellpadding="0" cellspacing="0" style="margin-top: 2px; font-size: 10px; line-height: 1.45;">
        <tr>
          <td style="font-weight: bold; color: #0d1635; width: 50px;">Name:</td>
